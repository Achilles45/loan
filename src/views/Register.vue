        ...
        <div class="register__wrapper container-fluid">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="register__heading text-center">
                            <h4>Sign Up For An Account</h4>
                            <p>It's very fast and easy</p>
                        </div>
                            ...
                            <form @submit.prevent="register()" action="">
                                ...
                                <option value="Zimbabwe">Zimbabwe</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="lname">Gender</label>
                                              <select name="" v-model="gender" id="" class="form-control">
                                   ...
                                   <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" v-model="password" class="form-control">
                                                  <small>Make use of letters, numbers and symbols to make a strong password</small>
                                            </div>
                                        </div>
                                             <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <small>By clicking on the register button, you agree to all our terms and conditions</small><br><br>
           ...
           if(!this.fname || !this.lname || !this.email || !this.phone || !this.country || !this.gender || !this.password || !this.repeatPassword){
               ...
               .then(cred=>{
                   db.collection('users').add({
                       email:this.email,
                       phone:this.phone,
                       first__name:this.fname,
                       last__name:this.lname,
...
.alert-danger{
    background: rgb(143, 37, 37) !important;
    font-size: .9rem;
    color: #fff;
    padding:1rem 2rem;
}
